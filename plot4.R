## This script creates a png file combining four line plots of energy readings across a 
...
# Set display to four plots in a 2 by 2 format
par(mfrow = c(2, 2))
...
# Top left plot: global active power readings over time
plot(filtered_data$Time, filtered_data$Global_active_power, type = "l", 
     xlab = "", ylab = "Global Active Power")

# Top right plot: voltage readings over time
plot(filtered_data$Time, filtered_data$Voltage, type = "l", xlab = "datetime", 
     ylab = "Voltage")

# Bottom left plot: all sub-metering readings over time
...
# Bottom right plot: global reactive power readings over time

## This script creates a png file for one line plot of global active power readings across 
...
# Plot global active power readings across time period with titles
